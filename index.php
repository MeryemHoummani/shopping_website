...
<body>
    ...
    <section id="product1" class="section-p1">
        ...
        <p>Summer Collection </p>
        <div class="pro-container">
        <?php include('server/get_arrivals_products.php');?>
        <?php while($row= $featured_products->fetch_assoc()){ ?>
            <div class="pro">
                <img src="img/products/<?php echo $row['product_image1'];?>" alt="" width="250px" height="250px">
                <div class="des">
                    <span><?php echo $row['product_name'];?></span>
                    <h5><?php echo $row['product_description'];?></h5>
                    <div class="star">
    ...
    <section id="sm-banner">
        <div class="banner-box">
            ...
            <span>The best classic dress is on sale at Mery Em shop</span>
